          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                  ...
                  icon: const Icon(
                    Icons.add_circle,
                    color: Color.fromRGBO(33, 135, 171, 1),
                  )),
              cartController.fav.value == true ? IconButton(
                    onPressed: () {
                      cartController.favoriteCart();
                      print(cartController.fav.value);
                    },
                    icon: const Icon(
                      Icons.favorite_border,
                      color: Color.fromRGBO(187, 5, 5, 1),
                    )) :
             IconButton(
                    onPressed: () {
                      cartController.removeFavoriteCart();
                    },
                    icon: const Icon(
                      Icons.favorite,
                      color: Color.fromRGBO(187, 5, 5, 1),
